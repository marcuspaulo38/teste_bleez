  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.10/jquery.mask.js"></script>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.1.1/sweetalert2.min.css">
       ...
       <script>
        	...
        	{
        		swal(
        		  'Erro, este Produto j&aacute; existe!',
        		  'Tente novamente!',
        		  'error'
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"></h6>
                     ...
                     <?php
                             ...
                             $form         = $_POST['formDadosProduto'];
                             $nomeP        = $_POST['inputProduto'];
                             ...
                             if ($form == "01")
                             {
                                 ...
                                 $query = ("SELECT * FROM produto where nome = '$nomeP'");
                                 $result = mysqli_query($mysqli, $query) or die("Erro ao verificar cliente".mysqli_error($query));
                                ...
                                
                                {
                                    ...
                                    if($imagem != NULL) {
                                       ...
                                       or die("Erro de inserir aqui : " . $sql . "<br>" . mysqli_error($mysqli));
                             ...
                             if ($form == "0101") 
                             {
                                 ...
                                 $descricao    = $_POST['inputDescricao'];
                                        ...
                                        $sql=  "UPDATE `produto` SET `preco` = '$preco', `descricao` = '$descricao' WHERE `produto`.`id` = $id;"
                               
                              or die("Erro de UPDATE aqui : " . $sql . "<br>" . mysqli_error($mysqli));
