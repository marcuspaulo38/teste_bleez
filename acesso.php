      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <div class="list-group">
              <a class="list-group-item"><i class="fas fa-fw fa-chart-area" aria-hidden="true"  style="color:#F36557"></i>&nbsp;<font  style="color:#484C51">Sistema de Teste</font></a>
             ...
             <font  style="color:#484C51">Marcus Paulo</font>
                      ...
                      <form method="POST" action="login.php">
                              ...
                              <div class='input-group h2'>
                                  <span class='input-group-btn'>
                                               <button class='btn btn-dark' type='submit' value="entrar" id="entrar" name="entrar">
                                                  <span class='glyphicon glyphicon-search'></span>Entrar
                                                </button>
                                                
                                                
                                               
                                                <!--  button class='btn btn-secondary' type='reset'>
                                                  <span class='glyphicon glyphicon-search'></span>Recuperar Senha
                                               </button-->
                                 </span>
                              </div>
					</form>      
                             ...
                             <div id="list" class="row">
                            	<div class="table-responsive col-md-12">
                            		<table class="table table-striped" cellspacing="0" cellpadding="0">
                            			...
                            			<tbody>
                            				<tr>
                            				    <td> Marcus Paulo: Analista e Desenvolvedor de Sistemas | marcusantoniopaulo@gmail.com | +55 [ 085 ] 98669.1853  | 98780.5453
                            				    <br> Copyright &copy;<font color="F36557">Marcus Paulo </font>  <?php echo date('Y');?>
                            				    </td>
      ...
      <!-- footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span><font style="color:black">Copyright &copy;<font style="color:black">Martplore Tecnologia e Projetos Industriais </a> All rights reserved. | Contato +55 85 98142.9095<br><br>Development by ASCINF TECNOLOGIA <?php echo date('Y')?> | Contato: +55 (085) 98669.1853</span>
